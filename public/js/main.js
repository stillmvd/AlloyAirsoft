...
var count = 0; //Счетчик для смены темы
...
document.getElementById('blockPhone').addEventListener('click', function () {
...
document.getElementById('blockEmail').addEventListener('click', function () {
  var range = document.createRange();
