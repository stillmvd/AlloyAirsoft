...
var count = document.getElementsByClassName('block').length;
var text = [],
  title = [],
  blocks = [];
setIdAndNameInput();
...
function removeColumns() {
  ...
  if (length <= 1) {} else {
    var block = document.getElementById('block' + (length - 1));
    block.remove();
...
/******/ 		}
/******/
/******/ 		var chunkLoadingGlobal = self["webpackChunkalloy_airsoft"] = self["webpackChunkalloy_airsoft"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/style","css/app"], () => (__webpack_require__("./resources/js/admin.js")))
