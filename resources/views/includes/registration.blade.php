<x-text.title class="text-center mt-20">
    {{ __('Registration') }}
</x-text.title>
<form action="{{ route('store', $game->id) }}" method="post" class="w-[86%] m-auto">
    @csrf
    <div class="flex flex-row justify-center mt-[65px]">
        <div class="flex flex-col mr-[29px] w-[643px] h-[302px]">
        ...
        <div class="flex flex-col w-[643px] h-[302px]">
            ...
            <select name="team" class=" h-[75px] mb-[20px] rounded-2xl ring ring-[#707070] bg-[#111111] focus:outline-none text-[#FFFFFF] text-[20px] pl-5" id="input_team">
