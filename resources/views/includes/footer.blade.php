<footer class="mt-20 mb-10">
    ...
    <div class="grid grid-cols-2 laptop:grid-cols-2 tablet-xl:grid-cols-1 zero:grid-cols-1">
        <div class="flex flex-col laptop:justify-start laptop:items-start tablet-xl:justify-center tablet-xl:items-center zero:justify-center zero:items-center">
            ...
            <div id="blockPhone" class="flex flex-row items-center pl-6 w-min rounded-2xl bg-card_bg group hover:bg-main ease-out duration-300 cursor-pointer">
                ...
                <b id="phone" class="whitespace-nowrap font-semibold text-dark bg-main p-6 rounded-2xl group-hover:bg-card_bg group-hover:text-white group-hover:scale-90 ease-out duration-100">
                    {{ $phone }}
                </b>
            </div>
            <div id="blockEmail" class="flex flex-row items-center pl-6 mt-6 w-min rounded-2xl bg-card_bg group hover:bg-main ease-out duration-300 cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" class="w-8 mr-4 group-hover:fill-dark" viewBox="0 0 16 16">
                    <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4Zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2Zm13 2.383-4.708 2.825L15 11.105V5.383Zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741ZM1 11.105l4.708-2.897L1 5.383v5.722Z"/>
                </svg>
                <b id="email" class="whitespace-nowrap font-semibold text-dark bg-main p-6 rounded-2xl group-hover:bg-card_bg group-hover:text-white group-hover:scale-90 ease-out duration-100">
                    {{ $email }}
                </b>
            </div>
        </div>
        ...
        <div class="flex flex-col laptop:justify-start laptop:items-start laptop:mt-0 tablet-xl:justify-center tablet-xl:items-center tablet-xl:mt-16 zero:justify-center zero:items-center zero:mt-16">
            ...
            <form action="{{ route('save_email') }}" method="POST" class="w-full flex flex-col laptop:items-start tablet-xl:items-center zero:items-center">
                ...
                @error('email')
                    <b class="px-6 py-2 mt-6 rounded-xl bg-card_bg text-red font-medium flex flex-row items-center whitespace-nowrap tablet-xl:whitespace-nowrap zero:whitespace-normal">
