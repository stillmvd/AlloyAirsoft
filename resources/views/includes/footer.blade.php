<footer class="my-20">
    ...
    <div class="grid grid-cols-2
        ...
        zero:items-center zero:justify-center">
            <x-text.subtitle class="mb-10 text-white">
                {{ __('Contacts') }}
            </x-text.subtitle>
            <div class="flex flex-row items-center pl-6 w-min rounded-2xl bg-card_bg group hover:bg-main ease-out duration-300 cursor-pointer">
                ...
                <x-text.paragraph class="font-medium leading-none whitespace-nowrap text-dark bg-main rounded-2xl p-6 group-hover:bg-card_bg group-hover:text-white group-hover:scale-90 ease-out duration-100">
                    +1-613-555-0137
                </x-text.paragraph>
            </div>
        ...
        zero:items-center zero:justify-center zero:mt-16">
            <x-text.subtitle class="mb-10 whitespace-nowrap text-white">
