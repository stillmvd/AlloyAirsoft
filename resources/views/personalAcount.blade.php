    ...
    <div class="hidden lg:grid w-full 2xl:w-[90%] grid-cols-1 lg:grid-cols-3 gap-10 mx-auto my-20">
            ...
            @if ($games->isNotEmpty())
                @foreach ($games as $game)
                    <div class="mt-10 flex flex-row">
                        <a href="" class="bg-dark/75 hover:bg-[#292929] rounded-tl-xl rounded-bl-xl flex items-center px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" />
                            </svg>
                        </a>
                        <a href="{{ route('game', $game->name) }}" class="bg-dark/75 hover:bg-dark w-full p-4 text-center">
                            {{ $game->name }}
                        </a>
                        <a href="" class="bg-dark/75 hover:bg-[#292929] rounded-tr-xl rounded-br-xl flex items-center px-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
        ...
        <div class="w-[100%] rounded-2xl bg-card_bg/50 px-6 pb-6">
            <div class="w-full flex flex-row items-center justify-center gap-x-10 my-10">
                ...
                @else
                    <img src="{{ asset('image/avatar_not_found.png') }}" alt="avatar" class="w-28 h-28 rounded-full select-none">
                @endif
            ...
            @if ($achievements->isNotEmpty())
                @for ($i = 0; $i < count($achievements); $i++)
                    <div class="grid grid-cols-3 mb-2">
                        <b class="bg-dark p-4 rounded-xl">
