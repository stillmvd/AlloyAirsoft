...
<div class="w-full relative mb-20">
    <a href="{{ route('game', $game->id) }}">
        <div class="h-[400px] md:h-[200px] w-full lg:w-7/12 relative group ring-2 mx-auto ring-main rounded-2xl p-6 overflow-hidden z-40">
            
            <h1 class="absolute text-4xl md:text-6xl w-min h-[400px] md:h-[200px] whitespace-nowrap z-50 left-0 right-0 top-[30%] md:top-[6%] mx-auto">
                {{ $game->name }}
            </h1>
            <div class="w-full h-[400px] md:h-[200px] bg-bg/75 backdrop-blur-[3px] absolute top-0 left-0 z-30"></div>
