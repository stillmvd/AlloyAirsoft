...
@section('content')
    ...
    <x-admin.form class="w-[40%] mx-auto" :count=$count>
        ...
        <x-admin.input placeholder="Game date" type="text" name="op-date" onfocus="(this.type='date')" onblur="(this.type='text')" />
        ...
        <div class="grid grid-cols-2 gap-x-6">
            <x-admin.input placeholder="First coordinates" type="text" name="first-cord" />
            <x-admin.input placeholder="Second coordinates" type="text" name="second-cord" />
        </div>
