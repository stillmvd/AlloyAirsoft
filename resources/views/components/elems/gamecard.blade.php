<div class="relative w-full">
    <a href="{{ route('game', strtolower($game->name)) }}">
        <div class="h-full lg:h-[300px] flex flex-col gap-y-10 lg:grid lg:grid-cols-2 lg:grid-rows-2 relative group ring-2 ring-main rounded-2xl p-6 overflow-hidden z-40">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d6937.594848843736!2d-78.6872054249482!3d44.0495167637283!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sru!2sru!4v1667372304868!5m2!1sru!2sru" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="w-full h-[500px] lg:h-[360px] scale-[1.3] lg:scale-[1.1] lg:group-hover:scale-[1.2] -top-[2%] lg:-top-[8%] ease-out duration-[.2s] absolute z-10"></iframe>
        </div>
    </a>
